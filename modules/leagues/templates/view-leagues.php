...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3">
            <a class="btn btn-lg btn-grad-2" href="javascript:newLeague();"
                style="width: 100%; height: 58px; line-height: 40px;">+ New League</a>
        </div>
    </div>
</div>
<br />
    ...
    foreach($leagues as $lg)
    {
      ?>
        ...
        <div class="col-md-4 col-lg-3">
            <div class="card">
                <div class="card-image text-center rounded-top"
                    style=" height: 150px; background-image: url('<?php echo $pub;?>uploads/8/723-scaled.jpg');background-size: cover;">
                </div>
                <div class="card-body">
                    <h5 class="card-title text-white"><?php echo $lg['league_name'];?></h5>
                    <p style="line-height: 0.7rem; font-size: 0.7rem; color: #999999;">Australia<br />Jul 2025 - Jun
                        2026</p>
                    <?php
        ...
        ?>
                    <div>
                        <div class="float-start"
                            style="margin-right: 10px; background-color: #ffcc00; border-radius: 20px; color: #000; width: 30px; height: 30px; text-align: center;">
                            <img src="<?php echo $pub;?>assets/aos.svg" width="20" /></div>
                        <div class="float-start" style="padding-top: 4px;"><?php echo $lg['league_events_qty'];?> Events
                        </div>
                    </div>
                    <a href="<?php echo $pub;?>my-leagues/?e=<?php echo $lg['league_hash'];?>"
                        class="float-end btn btn-grad-2">Manage</a>
                </div>
            </div>
        </div>
